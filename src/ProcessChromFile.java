...
//            double icMBF = window.calccMBF();
            double icMBF = window.calccMBF2();
//            if (icMBF != icMBF2) {
//              
//                System.out.printf("%s\t%d\t%d\t%.5f\t%.5f\n", cN, iS, iE, icMBF, icMBF2);
//                System.out.println(window);
//               System.out.println(window.mf.minHeap);
//               System.exit(1);
//           }
            //System.out.println(icMBF2 == icMBF);
            pw.printf("%s\t%d\t%d\t%.5f\n", cN, iS, iE, icMBF);
        } catch (Exception e) {
